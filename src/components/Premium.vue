...
<br><br>
Lakukan membership hanya dalam hitungan detik! Cukup masukan ID/Nomor Hp Anda yang sudah terdaftar, masukkan kode redeem Anda jika ada, kemudian selesaikan pembayaran. Setelah pembayaran berhasil Anda akan secara langsung akan menjadi membership di oracle.
<br><br>
Bayarlah menggunakan GoPay, OVO, DANA, hingga Transfer Bank.  Oracle adalah cara terbaik untuk top up secara online tanpa kartu kredit. Anda juga dapat mendaftarkan sebagai pengguna membership dan mendapatkan diskon yang menarik.
            </p>
          </div>
        </div>
      </div>
      <div class=" col-xs-6 ng-scope heading-content">
              <div class="section" style="padding:30px">
                  ...
                  <div>
                    <input class="form-input " type="text" placeholder="Silahkan masukan Kode anda">
                  </div>
                  <p class="field-instruction-text mt-2">
                    Jika Anda memiliki kode redeem, silakan masukkan di atas. abaikan jika Anda tidak memilikinya.
                  </p>
              </div>
              <div class="section" style="padding:30px">
